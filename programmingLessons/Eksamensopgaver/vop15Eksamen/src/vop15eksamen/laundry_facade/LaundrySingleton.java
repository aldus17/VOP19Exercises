...
/**
 * VOP Eksamen F15 Næsten færdig klasse, representerende et vaskeri til opgave 3
 * Kun mekanismerne der gør klassen til en singleton-klasse mangler at blive
 * implementeret.
 *
 * @author erso
 */
...
// Her implementeres constructor mm. så det bliver en singleton-klasse:
    ...
    private static LaundrySingleton laundryInstance = null;

    public LaundrySingleton() {
        laundryMachines = new LaundryMachine[3];
    }

    public static LaundrySingleton getInstance() {
//        return new LaundrySingleton();
        if (laundryInstance == null) {
            laundryInstance = new LaundrySingleton();
        }
        return laundryInstance;
    }
