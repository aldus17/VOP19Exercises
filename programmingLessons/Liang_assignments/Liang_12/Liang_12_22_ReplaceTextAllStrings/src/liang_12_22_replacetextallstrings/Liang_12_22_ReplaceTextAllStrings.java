package liang_12_22_replacetextallstrings;

/**
 * *******************************************************************************
 * (Replace text) Revise Programming Exercise 12.16 to replace a string in a
 * file * with a new string for all files in the specified directory using the
 * command: * * java Exercise12_22 dir oldString newString *
 * *******************************************************************************
 */
import java.util.*;
import java.io.*;

public class Liang_12_22_ReplaceTextAllStrings {
