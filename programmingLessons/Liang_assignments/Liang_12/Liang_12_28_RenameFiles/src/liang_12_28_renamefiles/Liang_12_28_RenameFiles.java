package liang_12_28_renamefiles;
 ...
 * * if i is a single digit. For example, a file named Exercise2_1 in a
 * directory * will be renamed to Exercise02_1. In Java, when you pass the
 * symbol * from the * command line, it refers to all files in the directory
...
public class Liang_12_28_RenameFiles {
