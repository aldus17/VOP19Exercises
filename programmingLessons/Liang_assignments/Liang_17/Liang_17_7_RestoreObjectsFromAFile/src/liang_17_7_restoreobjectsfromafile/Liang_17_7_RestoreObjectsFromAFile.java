package liang_17_7_restoreobjectsfromafile;
...
public class Liang_17_7_RestoreObjectsFromAFile {

    public static void main(String[] args)
            throws IOException, ClassNotFoundException {
        try ( // Create an input stream for file Exercise17.07.dat
                ObjectInputStream input = new ObjectInputStream(new BufferedInputStream(new FileInputStream("Exercise17_07.dat")))) { // Read Loan objects from file and display the total loan amount
            while (true) {
